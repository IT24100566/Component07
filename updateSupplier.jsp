...
<head>
    ...
    <title>Update Supplier | Inventory System</title>
            ...
            <div class="card-body">
                ...
                <form action="${pageContext.request.contextPath}/supplier/edit" method="post">
                    ...
                    <div class="text-center">
                        ...
                        <a href="${pageContext.request.contextPath}/supplier/list" class="btn btn-secondary ms-2">
